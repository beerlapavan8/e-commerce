...
//  console.log(props.idofbutton)
  async function deletion(e)
  {
    try {
      const val =e.currentTarget.value;
      const response = await axios.delete(`https://e-commerce-phok.onrender.com/productdelete/${val}`)
  ...
  return (
      ...
      <tr>
              <td className="px-6 py-4 border-b border-gray-200">{props.productid}</td>
              <td className="px-6 py-4 truncate border-b border-gray-200">{props.productname}</td>
              <td className="px-6 py-4 border-b border-gray-200">{props.rating}</td>
